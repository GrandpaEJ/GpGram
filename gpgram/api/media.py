...
async def download_file(
    file_id: str, bot, destination: str | Path | BinaryIO | None = None
) -> bytes | str | None:
    """
...
async def create_media_group(
    media_type: str,
    media_files: list[str | BinaryIO | tuple[str | BinaryIO, str]],
...
async def download_profile_photos(
    user_id: int, bot, destination_folder: str | Path, limit: int = 1
) -> list[str]:
    """
